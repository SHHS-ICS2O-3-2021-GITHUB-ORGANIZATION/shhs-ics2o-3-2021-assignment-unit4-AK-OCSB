...
# PURPOSE OF PROGRAM:Practice using different programs on strings and using exit codes.
...
#propmt user and ask if they would like to play again
...
#if user doesn't enter the proper words program ends
else:
